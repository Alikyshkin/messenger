...
class OAuthService {
  static Future<OAuthProviders> getProviders() => oauth_impl.OAuthServiceImpl.getProviders();
  static Future<AuthResponse?> signInWithGoogle() => oauth_impl.OAuthServiceImpl.signInWithGoogle();
  static Future<AuthResponse?> signInWithVk() => oauth_impl.OAuthServiceImpl.signInWithVk();
  static Future<void> signInWithTelegram() => oauth_impl.OAuthServiceImpl.signInWithTelegram();
