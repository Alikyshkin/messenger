...
class AppLocalizations {
  ...
  static const Map<String, String> _ru = {
    ...
    'cache_description': 'Скачанные файлы, голосовые и видео хранятся в полноразмерном виде на устройстве.',
    ...
    'delete_account_confirm_body': 'Аккаунт и все данные (чаты, сообщения, контакты) будут удалены безвозвратно. Выйти?',
    ...
    'no_connection_message': 'Нет связи. Сообщение будет отправлено при появлении сети.',
    ...
    'forgot_email_sent': 'Если аккаунт с таким email есть, на него отправлена ссылка для сброса пароля. Проверьте почту и перейдите по ссылке.',
    'forgot_email_prompt': 'Введите email, указанный при регистрации. Мы отправим ссылку для сброса пароля.',
    ...
    'group_call_coming': 'Групповой видеозвонок будет доступен в следующей версии',
  ...
  static const Map<String, String> _en = {
    ...
    'cache_description': 'Downloaded files, voice and video are stored in full size on device.',
    'clear_cache_by_chat': 'Clear by chat',
    'clear_all_cache': 'Clear all cache',
    'account_section': 'Account',
    'delete_account': 'Delete account',
    'delete_account_confirm_title': 'Delete account?',
    'delete_account_confirm_body': 'Account and all data (chats, messages, contacts) will be permanently deleted. Continue?',
    ...
    'forgot_email_sent': 'If an account with this email exists, a reset link has been sent. Check your inbox and follow the link.',
    'forgot_email_prompt': 'Enter the email you used to register. We will send a password reset link.',
    ...
    'possible_friends_empty': 'Add a phone number in your profile and grant contacts access.\nTap «Sync contacts» to find friends from your contacts.',
    'new_group': 'New group',
